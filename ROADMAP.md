...
- [x] **2.3.1 Parallel checkpointing**: The checkpoint loop is serial per-shard. With 16 shards and millions of dirty pages, this dominates shutdown time. Parallelize across shards + file handles.
...
- [x] **2.3.3 Compression v2**: The ALP, bitpacking, delta, dict, and RLE codecs exist. Profile which codecs are selected for typical workloads. Add adaptive compression that learns from access patterns.
